...
public class HooksApiTest {
     ...
     */
    @Test
    public void deleteV1HooksIdTest() throws ApiException {
        String userKey = null;
        String authorization = null;
        String id = null;
        // api.deleteV1HooksId(userKey, authorization, id);
     ...
     */
    @Test
    public void getV1HooksTest() throws ApiException {
        String userKey = null;
        String authorization = null;
        // HooksCollection response = api.getV1Hooks(userKey, authorization);
     ...
     */
    @Test
    public void postV1HooksTest() throws ApiException {
        String userKey = null;
        String authorization = null;
        PostV1Hooks v1Hooks = null;
        // Hook response = api.postV1Hooks(userKey, authorization, v1Hooks);
