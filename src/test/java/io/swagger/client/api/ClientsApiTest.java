...
public class ClientsApiTest {
     ...
     */
    @Test
    public void deleteV1ClientsClientIdTest() throws ApiException {
        String userKey = null;
        String authorization = null;
        String clientId = null;
        // api.deleteV1ClientsClientId(userKey, authorization, clientId);
     ...
     */
    @Test
    public void postV1ClientsTest() throws ApiException {
        String userKey = null;
        String authorization = null;
        // ClientCredentials response = api.postV1Clients(userKey, authorization);
